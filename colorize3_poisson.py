...
class FontColor(object):
    ...
    def __init__(self, col_file):
        ...
        # computations:
        self.colorsRGB = self.colorsRGB[(self.colorsRGB[:,0:3] < 10).all(axis=1)]
        
        print(self.colorsRGB.shape)
...
class Colorize(object):
    ...
    def __init__(self, model_dir='data'):#, im_path):
        ...
        self.font_color = FontColor(col_file=osp.join(model_dir,'models/colors_old.cp'))
